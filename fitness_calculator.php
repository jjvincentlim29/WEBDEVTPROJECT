...
<div class="box">
	<div class="box_left">
      ...
      <a href="fitnesscalcu.php?id=<?php echo $_SESSION['userid']; ?>">Fitness Calculator</a> &gt; Pace 
    </div>
	<div class="box_right">
...
$pace = $time/$distance;
$hourO = (int)($pace/3600);
$minuteO = (int)(($pace%3600)/60);
if($minuteO!=0){
	$secondO = (int)(($pace%$minuteO));
}else{
	$secondO = 0;
}
echo "<p>Pace: ".$hourO.":".$minuteO.":".$secondO." per Kilometer</p>";
echo "-------------------------------------<br />";
?>
