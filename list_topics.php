...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_forum; ?>">Forums</a> &gt; <a href="list_topics.php?parent=<?php echo $id; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
	<div class="box_right">
...
{
?>
<div class="message">No topics had been created yet.</div>
<?php
}
if(isset($_SESSION['username']))
{
