...
<div class="box">
    ...
    <form action="tracking.php" method="post">
		Please fill this form to create your track:<br /><br />
        <label for="title">Type of Exercise</label><input type="text" value="<?php echo htmlentities($otitle, ENT_QUOTES, 'UTF-8'); ?>" id="type" name="type" /><br />
        <label for="message">Description</label><textarea cols="40" rows="5" id="description" name="message"><?php echo htmlentities($omessage, ENT_QUOTES, 'UTF-8'); ?></textarea><br />
